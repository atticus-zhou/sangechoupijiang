...
class ReleaseReadinessVerifierTests(unittest.TestCase):
    def test_json_runs_all_public_release_gates(self):
        ...
        self.assertIn("downloads=6", static_showcase["summary"])
    ...
    def test_markdown_is_release_operator_readable(self):
        ...
        self.assertIn("downloads=6; catalog=7; fast_review=5/5; reading_guide=6/6; quick_start=5/5; post_run=3/3; handoff_recovery=4:regenerate_images; backend=False", completed.stdout)
