...
class ReleaseReadinessVerifierTests(unittest.TestCase):
    def test_json_runs_all_public_release_gates(self):
        ...
        self.assertIn("runtime=2/no_key=True/real_models=False", public_demo["summary"])
        ...
        self.assertIn("reading_guide=12/12", static_showcase["summary"])
        ...
        self.assertIn("download_acceptance=12", static_showcase["summary"])
    ...
    def test_markdown_is_release_operator_readable(self):
        ...
        self.assertIn("runtime=2/no_key=True/real_models=False", completed.stdout)
        ...
        self.assertIn("downloads=8; catalog=12; fast_review=5/5; reading_guide=12/12; quick_start=5/5; post_run=3/3; visitor_route=8; download_acceptance=12; handoff_recovery=12:regenerate_images; backend=False", completed.stdout)
