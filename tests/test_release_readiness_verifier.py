...
class ReleaseReadinessVerifierTests(unittest.TestCase):
    def test_json_runs_all_public_release_gates(self):
        ...
        self.assertIn("downloads=7", static_showcase["summary"])
        self.assertIn("fast_review=5/5", static_showcase["summary"])
        self.assertIn("reading_guide=7/7", static_showcase["summary"])
    ...
    def test_markdown_is_release_operator_readable(self):
        ...
        self.assertIn("downloads=7; catalog=8; fast_review=5/5; reading_guide=7/7; quick_start=5/5; post_run=3/3; visitor_route=7; download_acceptance=8; handoff_recovery=4:regenerate_images; backend=False", completed.stdout)
