...
class ReleaseReadinessVerifierTests(unittest.TestCase):
    ...
    def test_markdown_is_release_operator_readable(self):
        ...
        self.assertIn("downloads=8; catalog=9; fast_review=5/5; reading_guide=9/9; quick_start=5/5; post_run=3/3; visitor_route=8; download_acceptance=9; handoff_recovery=9:regenerate_images; backend=False", completed.stdout)
