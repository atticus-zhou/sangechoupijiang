...
class OfficeExtensionGovernanceVerifierTests(unittest.TestCase):
    def test_json_proves_primary_office_can_be_promoted(self):
        ...
        self.assertEqual(audit["schema_registry_audit"]["status"], "passed")
        self.assertEqual(audit["schema_registry_audit"]["binding_count"], 11)
        self.assertEqual(audit["schema_registry_audit"]["missing_provider_offices"], [])
        self.assertEqual(audit["recovery_registry_audit"]["status"], "passed")
        self.assertEqual(audit["recovery_registry_audit"]["binding_count"], 12)
        self.assertEqual(audit["recovery_registry_audit"]["error_count"], 0)
    ...
    def test_markdown_lists_four_primary_standards(self):
        ...
        self.assertIn("Schema Gate Registry Audit", completed.stdout)
        self.assertIn("Bindings: `11/11`", completed.stdout)
        self.assertIn("Recovery Registry Audit", completed.stdout)
