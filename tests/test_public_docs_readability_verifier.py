...
class PublicDocsReadabilityVerifierTests(unittest.TestCase):
    def test_json_verifies_public_docs_are_readable_and_release_oriented(self):
        ...
        self.assertIn("docs/OFFICE_EXTENSION_PROTOCOL.md", checked_paths)
    ...
    def test_markdown_is_operator_readable(self):
        ...
        self.assertIn("new office extension protocol", completed.stdout)
        ...
        self.assertIn("docs/OFFICE_EXTENSION_PROTOCOL.md", completed.stdout)
