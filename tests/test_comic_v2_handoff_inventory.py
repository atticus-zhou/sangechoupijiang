...
class ComicV2HandoffInventoryTests(unittest.TestCase):
    def test_inventory_classifies_fixture_as_demo_only(self):
        ...
        self.assertIn("| Recommended | Duplicate group | Claim | Score | Visual evidence | Images | Usable | Rework | Rework rate |", markdown)
        self.assertIn("demo_structure_verified | 100/100 | fixture_only | 7 | 7 | 0 | 0% |", markdown)
