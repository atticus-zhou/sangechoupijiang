...
class ProductEvolutionTasklistTests(unittest.TestCase):
    ...
    def test_stage_a_trusted_showcase_documents_readme_and_safety(self):
        ...
        self.assertIn("真实产品截图、八份下载物、十二个可复核文件、阅读指南、下游生产 quick-start 和安全边界", text)
    ...
    def test_development_checklist_verifier_is_part_of_required_loop(self):
        ...
        self.assertIn("python scripts/verify_comic_real_run_evidence_intake.py --latest --format markdown", text)
        self.assertIn("--manifest output/你的项目/xxx_handoff_manifest.json", text)
