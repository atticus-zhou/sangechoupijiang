...
class StaticPublicShowcaseTests(unittest.TestCase):
    ...
    def test_export_is_backend_free_and_contains_real_downloads(self):
        ...
        self.assertEqual(showcase["visitor_acceptance_guide"]["download_count"], 9)
        ...
        self.assertEqual(len(visitor_guide["download_acceptance"]), 9)
        ...
        self.assertEqual(showcase["static_export"]["reviewable_file_count"], 9)
    ...
    def test_static_readiness_verifier_is_public_operator_readable(self):
        ...
        self.assertIn("Visitor acceptance guide: 8 steps / downloads=9 / live=external_required", completed.stdout)
