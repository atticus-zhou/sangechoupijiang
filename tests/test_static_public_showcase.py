...
class StaticPublicShowcaseTests(unittest.TestCase):
    ...
    def test_export_is_backend_free_and_contains_real_downloads(self):
        ...
        self.assertEqual(showcase["visitor_acceptance_guide"]["download_count"], 11)
        ...
        self.assertEqual(len(visitor_guide["download_acceptance"]), 11)
        ...
        self.assertEqual(showcase["static_export"]["reviewable_file_count"], 11)
    ...
    def test_static_readiness_verifier_is_public_operator_readable(self):
        ...
        self.assertIn("Reviewable catalog: 11 files", completed.stdout)
        self.assertIn("Visitor acceptance guide: 8 steps / downloads=11 / live=external_required", completed.stdout)
        ...
        self.assertIn("Reading guide: 11/11", completed.stdout)
