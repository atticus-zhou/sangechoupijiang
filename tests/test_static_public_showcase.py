...
class StaticPublicShowcaseTests(unittest.TestCase):
    ...
    def test_export_is_backend_free_and_contains_real_downloads(self):
        ...
        self.assertEqual(showcase["visitor_acceptance_guide"]["download_count"], 10)
        ...
        self.assertEqual(len(visitor_guide["download_acceptance"]), 10)
        ...
        self.assertEqual(showcase["static_export"]["reviewable_file_count"], 10)
    ...
    def test_static_readiness_verifier_is_public_operator_readable(self):
        ...
        self.assertIn("Reviewable catalog: 10 files", completed.stdout)
        self.assertIn("Visitor acceptance guide: 8 steps / downloads=10 / live=external_required", completed.stdout)
        ...
        self.assertIn("Handoff recovery inventory: 9 items / actions=regenerate_images", completed.stdout)
        self.assertIn("Handoff asset type quality: character=18/18, rework=0; prop=18/18, rework=0; scene=27/27, rework=0", completed.stdout)
        self.assertIn("Fast review route: 5/5", completed.stdout)
        self.assertIn("Reading guide: 10/10", completed.stdout)
