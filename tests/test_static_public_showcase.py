...
class StaticPublicShowcaseTests(unittest.TestCase):
    ...
    def test_export_is_backend_free_and_contains_real_downloads(self):
        ...
        self.assertEqual(showcase["visitor_acceptance_guide"]["download_count"], 13)
        ...
        self.assertEqual(len(visitor_guide["download_acceptance"]), 13)
        ...
        self.assertEqual(showcase["static_export"]["reviewable_file_count"], 13)
    ...
    def test_static_readiness_verifier_is_public_operator_readable(self):
        ...
        self.assertIn("Reviewable catalog: 13 files", completed.stdout)
        self.assertIn("Visitor acceptance guide: 8 steps / downloads=13 / live=external_required", completed.stdout)
        ...
        self.assertIn("Reading guide: 13/13", completed.stdout)
