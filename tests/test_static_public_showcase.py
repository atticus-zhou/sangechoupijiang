...
class StaticPublicShowcaseTests(unittest.TestCase):
    ...
    def test_static_readiness_verifier_is_public_operator_readable(self):
        ...
        self.assertIn("Reviewable catalog: 15 files", completed.stdout)
        self.assertIn("Visitor acceptance guide: 8 steps / downloads=15 / live=external_required", completed.stdout)
        ...
        self.assertIn("Reading guide: 15/15", completed.stdout)
