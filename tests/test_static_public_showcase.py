...
class StaticPublicShowcaseTests(unittest.TestCase):
    ...
    def test_static_readiness_verifier_is_public_operator_readable(self):
        ...
        self.assertIn("Reviewable catalog: 14 files", completed.stdout)
        self.assertIn("Visitor acceptance guide: 8 steps / downloads=14 / live=external_required", completed.stdout)
        ...
        self.assertIn("Reading guide: 14/14", completed.stdout)
