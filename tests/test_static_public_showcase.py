...
class StaticPublicShowcaseTests(unittest.TestCase):
    ...
    def test_export_is_backend_free_and_contains_real_downloads(self):
        ...
        self.assertEqual(showcase["visitor_acceptance_guide"]["step_count"], 5)
        self.assertEqual(showcase["visitor_acceptance_guide"]["download_count"], 7)
        ...
        self.assertEqual(len(visitor_guide["visitor_route"]), 5)
        self.assertEqual(len(visitor_guide["download_acceptance"]), 7)
    ...
    def test_static_readiness_verifier_is_public_operator_readable(self):
        ...
        self.assertIn("Visitor acceptance guide: 5 steps / downloads=7 / live=external_required", completed.stdout)
