    ...
    checks = [
        ...
        _check(
            ...
            [
                ...
                _contains(root / "src/config_manager.py", "_research_retry_action"),
                _contains(root / "src/config_manager.py", "delivery/build"),
                _contains(root / "src/config_manager.py", "recover-artifacts"),
                ...
                _contains(root / "src/web/app.py", "整理已有研究产出"),
