...
| P3 | 从 GitHub 下载项目后，开发者能复现本地运行路径 | 已具备第一次运行清单和首次运行决策卡 | `docs/FIRST_RUN_DECISION_CARD.md`、`python scripts/verify_first_run_readiness.py --format markdown`、`python scripts/doctor.py`、`README.md` |
