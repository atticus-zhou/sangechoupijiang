...
| ID | 产品化承诺 | 当前状态 | 权威证据 |
| --- | --- | --- | --- |
| P1 | 个人网站和公开作品集可以展示产品，但不暴露真实 API Key | 已具备 demo-only 展示边界 | `python scripts/verify_public_demo_mode.py --format markdown`、`/api/demo/public-showcase`、`docs/DEPLOYMENT_MODES.md` |
