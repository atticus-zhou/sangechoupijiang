...
REQUIREMENTS: list[dict[str, Any]] = [
    {
        ...
        "files": [
            ...
            "scripts/verify_public_showcase_live.py",
    ...
    },
    {
        ...
        "markers": [
            ...
            "npm run ship:vercel",
            "verify_public_showcase_live.py",
    ...
    },
    {
        ...
        "files": [
            ...
            "scripts/verify_office_schema_registry.py",
            "scripts/verify_office_recovery_registry.py",
            "src/office_schema_registry.py",
            "src/office_recovery_registry.py",
            "docs/NEW_OFFICE_STARTER_CHECKLIST.md",
            "src/offices.py",
        ],
    },
