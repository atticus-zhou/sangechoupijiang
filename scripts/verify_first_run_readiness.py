...
def _first_run_file_reason(path: str) -> str:
    reasons = {
        ...
        "start_windows.bat": "Gives Windows users a single local startup entry: dependency check, doctor check, then run.py.",
        ...
        "model_setup_ladder": [
            {
                ...
                "title": "公开无 Key 演示",
                "required_models": [],
                "can_do": "查看固定样例、下载八份交付物、阅读 quick-start 和安全边界。",
