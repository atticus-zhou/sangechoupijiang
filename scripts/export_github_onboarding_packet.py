...
def _write_readme(output_dir: Path, manifest: dict[str, Any]) -> None:
    lines = [
        ...
        "",
        "1. `README.md`",
        "2. `docs/FIRST_RUN_DECISION_CARD.md`",
        "3. `docs/MODEL_CONFIGURATION.md`",
        "4. `verification/first_run.json`",
        "5. `verification/model_guidance.json`",
        "6. `verification/public_docs.json`",
        "7. `verification/secret_scan.txt`",
        "",
        "Safe boundary:",
        "",
